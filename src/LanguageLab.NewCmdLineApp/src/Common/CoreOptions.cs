namespace LanguageLab.NewCmdLineApp.Common
{
    ...
    public class CoreOptions
    {
        ...
        /// </summary>
        public DirectoryInfo TargetDirectory { get; set; } = new DirectoryInfo(Environment.GetFolderPath(Environment.SpecialFolder.Desktop));
        ...
        public bool AllChildDirectories { get; set; }
        ...
        /// </summary>
        public OutputType OutputFileType { get; set; } = OutputType.Xlsx;
    }
}